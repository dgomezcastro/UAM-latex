...
\begin{frame}{\texttt{typst}}
	...
	\end{quote}
	La versión actual es 0.14 y ya se considera listo para todo tipo de usos.
\end{frame}

\begin{frame}{Typst for LaTeX users}
...
\begin{frame}{Ejercicio (opcional)}
	Repetir la entrega 4 utilizando \texttt{typst}.
\end{frame}
