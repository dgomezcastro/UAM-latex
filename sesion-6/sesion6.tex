...
El paquete \texttt{tikz} nos permite general dibujos 
	\begin{columns} 
		\column{.5\textwidth}
		\begin{block}{Código} 
			\VerbatimInput[fontsize=\footnotesize]{codigos/ejemplo-tikz.tex}
		\end{block} 
		\column{.4\textwidth}
		\begin{figure} 
...
\begin{columns} 
	\column{.5\textwidth}
	\begin{block}{Código} 
		\VerbatimInput[fontsize=\footnotesize]{codigos/ejemplo-tikz-2.tex}
	\end{block} 
	\column{.4\textwidth}
		\fbox{\input{codigos/ejemplo-tikz-2.tex}}
\end{columns}
...
\begin{frame}
	...
	\begin{block}{Código} 
		\VerbatimInput[fontsize=\tiny]{codigos/ejemplo-tikz-graph.tex}
	\end{block} 
...
\begin{frame}
	\frametitle{Representación de curvas} 
		\begin{block}{Código} 
			\VerbatimInput[fontsize=\tiny]{codigos/ejemplo-tikz-curva.tex}
		\end{block} 
		\begin{figure} 
			\centering
...
\frametitle{Representación de funciones: \texttt{pgfplots}} 
	...
	\column{.55\textwidth}
	\begin{block}{Código} 
		\VerbatimInput[fontsize=\footnotesize]{codigos/ejemplo-tikz-curva-2.tex}
	\end{block} 
	\column{.4\textwidth}
	\begin{figure} 
...
\begin{frame}
	...
	\begin{columns} 
		\column{.55\textwidth}
		\begin{block}{Código} 
			\VerbatimInput[fontsize=\footnotesize]{codigos/ejemplo-pgfplots-pointwise-data.tex}
		\end{block} 
	
		\begin{block}{Código [data.csv]} 
			\VerbatimInput[fontsize=\tiny]{codigos/data.csv}
		\end{block} 
		\column{.4\textwidth}
		\begin{figure} 
