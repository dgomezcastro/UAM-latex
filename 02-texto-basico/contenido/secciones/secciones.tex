...
\begin{frame}[fragile]
	...
	Se puede generar el índice introduciendo \latexinline{\tableofcontents}. 
	
	Este comando admite parámetros optativos.  \\ 
	
	\pause 
	
	También se pueden hacer otras tablas de contenidos: 
	
	\latexinline{\listoffigures}, \latexinline {\listoftables}.
\end{frame}

\begin{frame}[fragile]{Secciones e índice}
	\latexinputandpdf{codigos/ejemplo-secciones}
\end{frame}