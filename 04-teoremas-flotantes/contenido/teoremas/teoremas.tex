...
\begin{frame}[fragile]
    \frametitle{Teoremas con \texttt{amsthm}}
...
\begin{frame}[fragile]
	...
	\scriptsize
	\latexinputandpdf{codigos/thm1}
\end{frame}

\begin{frame}[fragile]{Más allá de \texttt{amsthm}: \href{https://ctan.org/pkg/ntheorem}{\texttt{ntheorem}}}
	\scriptsize
	\codeandsomething
	{0.5}{0.45}
	{\latexfile{codigos/ntheorem.tex}}
	{\includegraphics[width=\textwidth]{codigos/ntheorem.pdf}}
\end{frame}