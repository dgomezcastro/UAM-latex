...
% \usepackage{verbatim}
\usepackage{minted} % not maintained. however minted in version 3 has breaking changes
...
\makeatletter
% \xpatchcmd and friends cannot be used directly in \IfPackageAtLeastTF args
...
\if@tempswa
% patch for minted v3.7.0 (2025-05-14)
\ifx\RobustInputMintedProcess\RobustInputMintedProcess@highlight
  \xpatchcmd\RobustInputMintedProcess@highlight
  {#3}
  {\import@path #3}
  {}{\PatchFailed}
